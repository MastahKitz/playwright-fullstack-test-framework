...
// `expected.username` is omitted for the auto-generated-username case, since the server
// derives that value and it can't be known ahead of the request.
export async function assertSignupSuccess(response: APIResponse, expected: { email: string; phone: string; username?: string }) {
